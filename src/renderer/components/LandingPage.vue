    ...
    <main>
      ...
      <div class="right-side">
        ...
        <div class="doc">
          ...
          <button class="alt" @click="ipcRenderer()">ipcRenderer</button>
        </div>
      </div>
    </main>
  </div>
...
export default {
  ...
  methods: {
    ...
    ipcRenderer() {
      ...
      console.log(ipcRenderer.sendSync("synchronous-message", "render ping")); // prints "pong"

      ipcRenderer.send("asynchronous-message", "render ping");
    }
  }
};
</script>
